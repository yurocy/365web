...
<table width="100%" border="0" align="center" cellpadding="2" cellspacing="1" class="border">
  <tr class="topbg">
    <td height="22" colspan="2" align="center"><strong>名 站 导 航 管 理</strong></td>
  </tr>
  <tr class="tdbg">
    <td width="70" height="30"><strong>管理导航：</strong></td>
    <td height="30"> <a href="Admin_Web_TopURL_Manage.asp?Action=list">网址管理</a> | <a href="Admin_Web_TopURL_Manage.asp?Action=Add">添加网站</a></td>
  </tr>
</table>
<br>
<%
...
%>
    <tr class="tdbg" onmouseout="this.style.backgroundColor=''" onmouseover="this.style.backgroundColor='#BFDFFF'">
      ...
      <td align="center">
<%
      response.write "<a href='Admin_Web_TopURL_Manage.asp?Action=Modify&ID=" & rs("ID") & "'>修改</a> | "
      response.write "<a href='Admin_Web_TopURL_Manage.asp?Action=Del&ID=" & rs("ID") & "' onclick='return ConfirmDel();'>删除</a>"
	  %>
