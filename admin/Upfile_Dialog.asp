...
sub upload_0()    '使用化境无组件上传类
	...
	for each formName in upload.file '列出所有上传了的文件
		...
		if FoundErr<>true then
			...
			strJS=strJS & "parent.document.form1.url.value='" & mid(fileName,4,1000) & "';" & vbcrlf
			strJS=strJS & "parent.document.form1.UpFileName.value='" & mid(fileName,4,1000) & "';" & vbcrlf
		else
