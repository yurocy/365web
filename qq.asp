...
<table width="845" height="30" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td width="100" background="/images/bx001.gif" class="w01"><div align="right"><iframe src="time.html" width="150" height="15" frameborder="0" marginwidth="0" marginheight="0" scrolling="no" name="I2"></iframe> </div></td>
   		 <td width="690" background="/images/bx001.gif">
			<p align="center"><font face="宋体"><font color="#009900" size="2">
			全讯网是专业收录各种网址,及时更新,是网民上网最好导航.精彩网络生活,由全讯网开始.直播现场</font><font color="#ff0000" size="2"><a target="_blank" href="http://www.411499.com/live.html"><span style="TEXT-DECORATION: none"><font color="#ff0000">点击进入</font></span></a>.</font></font></td>
  </tr>
</table>
...
<td width="600" class="w09" align="right">提示:帐户登陆,可永久保存收藏网址.</td>
<td width="1420">
          ...
          <tr>
            <td bgcolor="#ECECEC"><table width="700" border="0" align="center" cellpadding="10" cellspacing="0">
              <tr>
                ...
                <td width="600" class="w01" style="text-align:center; line-height:normal"> 客服热线:<%=webmobi%> <a target="blank" href="http://wpa.qq.com/msgrd?V=1&Uin=1602655797&Site=www.5532888.tk&Menu=yes"><img border="0" SRC=http://wpa.qq.com/pa?p=1:380324851:6 alt="点击这里给我发消息" align="absmiddle"></a> 客服时间:7×24小时  <%=weburl%> 技术支持 <br /> 声明:网上有诈骗.所有在本站刊登广告的网站和内容，一概与本站无关，请各位网友密切注意!<span style="display:none"><script language="javascript" src="http://count10.51yes.com/click.aspx?id=108194074&logo=12" charset="gb2312"></script>
</span><br />
                  <a href="http://www.miibeian.gov.cn/" target="_blank" style="color:#ECECEC; ">备案号:苏ICP备08107999号 <script language="javascript" src="http://count50.51yes.com/click.aspx?id=504799560&logo=12" charset="gb2312"></script>
</a> </td>
                <td width="1"></td>
              </tr>
            </table></td>
...
<%function show_ad(id)
	...
	'response.write adrs.recordcount
       adrs.move id
          show_ad="<a href='"&adrs("Site_Url")&"' target='_blank' style='color: "&adrs("Font_Color")&"'>"&adrs("Site_Title")&"</a>&nbsp;&nbsp;&nbsp;"
      else
	  show_ad="&nbsp;"
        end if
        adrs.close
