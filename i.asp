...
<script language="javascript">	
	...
	{	
		...
		for(var i=0;i<document.getElementsByTagName("table").length;i++){
			if(document.getElementsByTagName("table")[i].className=="classtable"){
				document.getElementsByTagName("table")[i].style.display = 'none';
				counts++;
			}
			if(document.getElementsByTagName("table")[i].id.substring(0,2) == 'ch')
	...
	function showall()
	{
		...
		for(var i=0;i<document.getElementsByTagName("table").length;i++){
			...
			if(document.getElementsByTagName("table")[i].id.substring(0,2) == 'ch')
				document.getElementsByTagName("table")[i].style.display = 'block';
			if(document.getElementsByTagName("table")[i].id.substring(0,7) == 'titleID')
				document.getElementsByTagName("table")[i].style.display = 'block';
		}
		hideallmenu();
		if(counts <= 1){
...
<div class="main">
    ...
    <tr>
      ...
      <table width="98%"  border="0" align="center" cellpadding="0" cellspacing="0">
        ...
        <table width="98%" height="28" style="line-height:28px;"  border="0" align="center" cellpadding="0" cellspacing="0">
          <tr>
            <td><div align="center"><span class="w05">公告栏：</span><span class="w01" style="color:#FFFFFF; ">
  ...
  <table width="845" height="94" border="0" align="center" cellpadding="1" cellspacing="0">
    <tr>
      ...
      <td width="574" background="/images/bx004.gif"><div id="ad_top" align="right"> <%=showinfo("横幅广告")%> </div></td>
      <td width="95" background="/images/bx004.gif"><table width="73" border="0" align="center" cellpadding="0" cellspacing="0">
          <tr>
            <td height="22" bgcolor="FFCC33" class="w01"><div align="center"><a href="javascript:HomepageFavorite.Favorite(window.location.href, document.title)" _fcksavedurl="javascript:HomepageFavorite.Favorite(window.location.href, document.title)" >收藏本站</a></div></td>
          </tr>
          <tr>
            <td height="10"></td>
          </tr>
          <tr>
            <td height="22" bgcolor="FFCC33" class="w01"><div align="center"><a href="javascript:HomepageFavorite.Homepage()" _fcksavedurl="javascript:HomepageFavorite.Homepage()" >设为首页</a></div></td>
          </tr>
        </table></td>
    </tr>
    <tr>
        ...
        <tr>
          <td width="693"><div id="info">
              <ul>
                ...
                <li><a onclick="selectChl('pID1')" id="spID1" href="#">热门推荐</a></li>
                <li><a href="#" onclick="selectChl('pID6')" id="spID6">博彩娱乐</a></li>
                <li><a href="#" onclick="selectChl('pID3')" id="spID3">比分天下</a></li>
                ...
                <li><a href="#" onclick="selectChl('pID9')" id="spID9">玩家帮助</a></li>
              </ul>
            </div></td>
  ...
  <!--头部-->
  <div class="ad_6" style="background:#E1E1E1"> <%=showinfo("公告栏下部广告")%> </div>
...
Fun_GetPostData();
  ...
  <div class="main" style="font-size:12px; background:#FFFFFF"> <%=showinfo("友情链接")%> </div>
          ...
          <tr>
            <td bgcolor="#ECECEC"><table width="700" border="0" align="center" cellpadding="10" cellspacing="0">
                <tr>
                  ...
                  <td width="600" class="w01" style="text-align:center; line-height:normal"> 客服QQ:1233333<font color="#000000"> EMAIL:12222222@qq.com </font> <font color="#0000FF"></font>客服时间:7×24小时<%=weburl%> 技术支持 <br />
                    声明:网上有诈骗.所有在本站刊登广告的网站和内容，一概与本站无关，请各位网友密切注意!<span style="display:none"> </span><br />
                    <a href="http://www.miibeian.gov.cn/" target="_blank" style="color:#ECECEC; ">备案号:粤ICP备08107990号 </a> &nbsp;<script src="http://s16.cnzz.com/stat.php?id=5144538&web_id=5144538&show=pic" language="JavaScript"></script></td>
                  <td width="1"></td>
                </tr>
              </table></td>
          </tr>
  ...
  <%
				...
				%>
  <!--左边5个-->
  <div id="Javascript.LeftDiv" style="position: absolute;z-index:999;top:-1000px;word-break:break-all;display:none;"> <%=ad_fg(0)%> </div>
  
  <!--右边5个-->
  <div id="Javascript.RightDiv" style="position: absolute;z-index:999;top:-1000px;word-break:break-all;display:none;"> <%=ad_fg(1)%> </div>
  <center>
  </center>
  <script language="javascript" type="text/javascript">
<!--
...
%>
  <table width="845" height="27" border="0" align="center" class="classtable" cellpadding="0" cellspacing="0"  id="pID<%=id%>" >
    <tr>
      <td>
      	<table width="845" height="27" border="0" align="center" cellpadding="0" cellspacing="0"  id="titleID<%=id%>" >
		...
		%>
          <table width="845" border="0" align="center" cellpadding="0" cellspacing="0" id="ch<%=rs("id")%>">
            <tr>
              ...
              <td width="815"><table width="100%"  border="0" cellpadding="3" cellspacing="1" class="table" bgcolor="<%=Bg_Color%>">
                  <%
		 	 tmp_num=1
